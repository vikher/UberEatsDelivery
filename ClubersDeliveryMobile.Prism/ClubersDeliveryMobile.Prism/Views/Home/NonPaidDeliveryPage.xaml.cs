...
{
    public partial class NonPaidDeliveryPage : ContentPage
    {
        private readonly IGeolocatorService _geolocatorService;
        private static NonPaidDeliveryPage _instance;
        public NonPaidDeliveryPage(IGeolocatorService geolocatorService)
        {
            InitializeComponent();
            _instance = this;
            _geolocatorService = geolocatorService;
        }
        public static NonPaidDeliveryPage GetInstance()
        {
            return _instance;
        }
