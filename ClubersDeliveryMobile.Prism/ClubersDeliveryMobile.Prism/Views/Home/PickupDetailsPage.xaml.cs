...
{
    public partial class PickupDetailsPage : ContentPage
    {
        private readonly IGeolocatorService _geolocatorService;
        private static PickupDetailsPage _instance;
        public PickupDetailsPage(IGeolocatorService geolocatorService)
        {
            InitializeComponent();
            _instance = this;
            _geolocatorService = geolocatorService;
        }
        public static PickupDetailsPage GetInstance()
        {
            return _instance;
        }
