...
{
    public partial class PaidDeliveryPage : ContentPage
    {
        private readonly IGeolocatorService _geolocatorService;
        private static PaidDeliveryPage _instance;
        public PaidDeliveryPage(IGeolocatorService geolocatorService)
        {
            InitializeComponent();
            _instance = this;
            _geolocatorService = geolocatorService;
        }
        public static PaidDeliveryPage GetInstance()
        {
            return _instance;
        }
