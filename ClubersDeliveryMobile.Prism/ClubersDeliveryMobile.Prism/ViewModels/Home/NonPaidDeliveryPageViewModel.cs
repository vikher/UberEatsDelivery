...
{
    public class NonPaidDeliveryPageViewModel : ViewModelBase
    {
        ...
        public NonPaidDeliveryPageViewModel(INavigationService navigationService,
        ...
        public DelegateCommand FinishDeliveryCommand => _finishDeliveryCommand ?? (_finishDeliveryCommand = new DelegateCommand(FinishOrderAsync));
        ...
        private async void FinishOrderAsync()
        {
            ...
            Response1<bool> response = await _apiService.FinalizeUnPaidOrder(Constants.urlBase, Constants.servicePrefix, Constants.FinalizeUnpaidOrderAppSRAsyncController, Constants.tokenType, token.Result.token, Order.OrderId);
